...
public class updatemeds extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("UPDATE MEDICINE");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (m_name.getText().isEmpty() || stocks.getText().isEmpty() || dosage.getText().isEmpty()) {
            ...
            String query = "UPDATE tbl_meds SET m_name=?, stocks=?, dosage=?";
            ...
            try {
                ...
                if (result == 1) {
                    ...
                    JOptionPane.showMessageDialog(null, "Failed to edit medicine");
                }
    ...
    public javax.swing.JTextField stocks;
